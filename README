...
* Giving an array to sections -item's "large" field, will convert it's contents to an <ul>, making each array item an <li>
* Adding a plain text string to list of sections, adds a <h2> -separator on the page
* The contents are NOT HTML encoded when outputting, to make it possible to do minor alterations, <sup>, <p>, etc.
